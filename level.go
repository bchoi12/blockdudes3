...
func (l *Level) loadTestLevel(grid *Grid) {
...

	{
		...
		b = building.AddBlock(tallBlockSubtype)
		b.AddOpenings(bottomLeftCardinal, topLeftCardinal, topRightCardinal)
		b.LoadSidedTemplate(stairsSidedBlockTemplate, NewRightCardinal())
		b.LoadSidedTemplate(secondFloorSidedBlockTemplate, NewLeftCardinal())
		b = building.AddBlock(balconyBlockSubtype)
		b.AddOpenings(topRightCardinal)
		b = building.AddBlock(roofBlockSubtype)
