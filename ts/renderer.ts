class Renderer {
	...
	addObject(type : ObjectType, id : number, mesh : any) : void { this._scene.addObject(type, id, mesh); }
	hasObject(type : ObjectType, id : number) : boolean { return this._scene.hasObject(type, id); }
	getObject(type : ObjectType, id : number) : any { return this._scene.getObject(type, id); }
	...
	deleteObject(type : ObjectType, id : number) : void { this._scene.deleteObject(type, id); }
	clearObjects(type : ObjectType) : void { this._scene.clearObjects(type); }
